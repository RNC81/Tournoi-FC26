...
export const generateNextRound = async (tournamentId, remix = true) => {
  try {
    const response = await apiClient.post(`/api/tournament/${tournamentId}/generate_next_round?remix=${remix}`);
    return response.data;
  } catch (error) {
