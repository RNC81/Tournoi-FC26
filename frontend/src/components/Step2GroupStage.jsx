        ...
        <>
          ...
          {allMatchesPlayed && (
            <div className="mt-16 EF-card p-8 border-blue-500/20 bg-gradient-to-b from-[#1F1F1F] to-[#141414]">
              <div className="text-center mb-8">
                ...
                <p className="text-zinc-400">Les <span className="text-blue-400 font-bold">{targetQualifiedCount}</span> premiers sont qualifiés pour la phase finale.</p>
              </div>
                      ...
                      return (
                        <tr key={index} className={`transition-colors ${isQualified ? 'bg-blue-900/10' : ''}`}>
                          ...
                          <td className="text-center py-3 px-2">
                            {isQualified ? <span className="text-blue-400 text-xs font-bold uppercase bg-blue-500/10 px-2 py-1 rounded">Qualifié</span> : <span className="text-zinc-600 text-xs uppercase">Éliminé</span>}
                          </td>
                        </tr>
                      );
                    })}
          ...
          {isAdmin && allMatchesPlayed && (
            <div className="flex justify-center mt-12 mb-8">
              <Button onClick={handleCompleteStageClick} disabled={isCompleting} className="EF-btn-primary py-6 px-10 text-lg shadow-[0_0_30px_rgba(59,130,246,0.2)]">
