...
import { Shuffle, ArrowRight, CheckCircle, XCircle, Loader2 } from 'lucide-react'; // Ajout Loader2
import { Button } from './ui/button';
import { useToast } from '../hooks/use-toast';
import { completeGroupStage } from '../api'; // Import API call

const Step3Qualification = ({ tournamentId, groups, qualifiedPlayers, eliminatedPlayers, onKnockoutDrawComplete }) => {
  // Les qualifiés et éliminés sont maintenant reçus directement via les props depuis TournamentManager
  ...
  const handleDrawKnockout = async () => {
    ...
    try {
        ...
        onKnockoutDrawComplete(updatedTournament); // Passe tout le tournoi à jour au parent
   ...
   const getRoundName = () => {
     ...
     // Gérer d'autres cas si nécessaire, ex: 32 joueurs -> 16èmes
     return "Phase finale"; // Fallback
   };
